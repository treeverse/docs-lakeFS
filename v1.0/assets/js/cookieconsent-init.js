...
cc.run({
  ...
  languages: {
    en: {
      consent_modal: {
        title:
          '<div style="display:flex;flex-direction:column;align-items:center;"><img style="padding-bottom:14px;" src="/v1.0/assets/img/cookies.png" /><div>Hello fellow axolotl, it\'s cookie time!</div></div>',
        description:
